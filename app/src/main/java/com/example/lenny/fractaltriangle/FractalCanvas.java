...
public class FractalCanvas extends View {
    ...
    void inscribeTriangle(Canvas canvas, FloatPoint origin, float size, int iterations) {
        ...
        // renderTriangle(canvas, vertex1, vertex2, vertex3);
    ...
    ArrayList<FloatPoint> midPoints(ArrayList<FloatLine> triangle) {
        ArrayList<FloatPoint> fpx = new ArrayList<>();
        for (FloatLine tl : triangle) {
            //fpx.add(new FloatPoint(tl.midPoint() );
